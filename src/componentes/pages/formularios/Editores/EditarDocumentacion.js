        ...
        <div className='contenedor_formulario_foto'>
          ...
          <form onSubmit={guardar_foto}>
                        ...
                        <div className='divisor_form'>
                            ...
                            <div className="form-group" id='nombrePeriodico'>
                                <label>Tipo :</label>
                                <input type="text" className='autor' name="tipo_documentacion" placeholder="Tipo de documentación" defaultValue={fotografia.tipo_documentacion || ''} onChange={cambiado} />
                            </div>
