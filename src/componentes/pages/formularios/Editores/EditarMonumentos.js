...
export const EditarMonumentos = () => {
  ...
  const guardar_foto = async (e) => {
    ...
    if (datos.status == "success") {
      ...
      const { subida2, cargando2 } = await Api("https://backend-prueba-apel.onrender.com/api/monumentos/registrar-imagen/" + id, "POST", formData, true);
      const { subida, cargando } = await Api("https://backend-google-fnsu.onrender.com/api/monumentos/editar-imagen/" + id, "POST", formData, true);
                        ...
                        <div className="form-group">
                            ...
                            <div className="form-group" id="nombrePeriodico">
                                ...
                                <select
                                    ...
                                    onChange={cambiado}
                                >
                                    <option value={fotografia.tipo_monumento}>{fotografia.tipo_monumento}</option>
                            ...
                            <div className="form-group" id='autor'>
                                ...
                                <input type="text" className='autor' name="descripcion_fisica" placeholder="Autor" defaultValue={fotografia.descripcion_fisica || ''} onChange={cambiado} />
                            </div>
                            <div className="form-group" id='autor'>
                            ...
                            <input
                                type="text"
                                name="ubicacion"
                                defaultValue={fotografia.ubicacion}
                                onChange={cambiado}
                            />
                            </div>
                            <div className="form-group" id='columnas' >
                                ...
                                <input
                                    ...
                                    name="entidad"
                                    placeholder="entidad"
                                    defaultValue={fotografia.entidad || ''}
                                    onChange={cambiado}
                                />
                            </div>
                            ...
                            <input
                                type="text"
                                name="inscripciones"
                                defaultValue={fotografia.inscripciones}
                                onChange={cambiado}
                            />
                            </div>
                            ...
                            <div className="form-group" id='columnas' >
                                ...
                                <input
                                    ...
                                    placeholder="evento"
                                    defaultValue={fotografia.fecha_inauguracion || ''}
                                    onChange={cambiado}
                                />
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                <select name="tema" value={formulario.tema || ''} onChange={cambiado}>
                                    <option value={fotografia.titulo}>Seleccionar el tema</option>
                                    <option value="Estatuas y esculturas">Estatuas y esculturas</option>
                                    <option value="Placas conmemorativas">Placas conmemorativas</option>
                                    <option value="Monumentos arquitectónicos">Monumentos arquitectónicos</option>
                                    <option value="Espacios públicos y parques">Espacios públicos y parques</option>
